export const termsPolicy = `<html>
  ...
  <body class="c7 doc-content">
    <p>
    <span class="text-big"><strong>Terms &amp; Conditions</strong></span>
</p>
<ol>
    <li>
    ...
    <li>
        This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://topreview.expert ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').&nbsp;
    </li>
    <li>
        The Platform is owned by GRYWUD CONSULTANTS PVT LTD Companies Act, 1956 with its registered office at ‘Platform Owner’, 'we', 'us', 'our').. , a company incorporated under the KARNATAKA (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our')..
    </li>
    <li>
